...
Yellow bullets: 23 → 12. Merged: truthdb #87–#111, docs #41–#66.
...
COLMETADATA precedes the first row). The remaining yellows are Stage 9
(sp_prepare family, sp_describe_first_result_set, the exit matrix), Stage 10
