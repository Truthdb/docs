...
Yellow bullets: 23 → 14. Merged: truthdb #87–#107, docs #41–#62.
...
lesson its review caught). The front of the queue is now Stage 7's **exit**
bullet (locale-ordering index tests — index keys carry full collation sort
keys since #94, so the tests are buildable now), then Stage 8's remaining
gaps: the all-NULL-group aggregate slt, and **streaming scans** for
